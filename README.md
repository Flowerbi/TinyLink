...
**TinyLink** — это веб приложение на Laravel + Vue, созданное для сокращения ссылки.
Проект включает возможность сокращать ссылки, сохранять сокращённые ссылки, остлеживать количество переходов по ссылке, отслеживать ip адреса клиента переходящего по сокращённой ссылке и время перехода.
